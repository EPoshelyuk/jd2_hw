...
import it.academy.ExpenseForServlet;
...
public class MyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            List<ExpenseForServlet> data = new ArrayList<>();
            ...
            while (result.next()) {
                ...
                ExpenseForServlet expense = new ExpenseForServlet();
          ...
          out.println("There is no connection to the database. You should try it later.");
        } catch (IOException | ServletException e) {
           out.println("Something is wrong. Reload the page or contact our support.");
